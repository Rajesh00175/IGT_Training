...
public class FabHotel_Search {
	...
	@Test(priority=3)
	public void fianlHotel_Book() throws InterruptedException {
		...
		no_of_Guest.click();
		List<WebElement> select_no_Guest = fabDriver.findElements(By.xpath("//div[@class='select-dropdown-wrap rooms_select_dropdown']/span"));
	...
	public void review_Details() throws InterruptedException {
		WebElement price_Breakup, close_Price_Breakup, proceed_Payment; // userName, user_Email, user_MobileNo, continue_Pay_GW;
		...
		price_Breakup = fabDriver.findElement(By.xpath("//div[contains(@class,'review_booking_price showPriceBreakUp')]"));
		price_Breakup.click();
		fabDriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);		
		...
		proceed_Payment = fabDriver.findElement(By.xpath("//div[contains(@class,'review_booking_continue submit-booking-details')]"));
		...
		userName = fabDriver.findElement(By.xpath("//input[contains(@class,'user-name required_param required_param_field')]"));
		userName.sendKeys("Saint John");
		user_Email = fabDriver.findElement(By.xpath("//input[contains(@class,'user-email required_param required_param_field')]"));
		user_Email.sendKeys("saintjohn@hotmail.com");
		user_MobileNo = fabDriver.findElement(By.xpath("//input[contains(@class,'user-mobile user_mobile required_param required_param_field')]"));
		user_MobileNo.sendKeys("9999323456");
		continue_Pay_GW = fabDriver.findElement(By.xpath("//div[contains(@class,'review_guest_continue submit-guest-details')]"));
